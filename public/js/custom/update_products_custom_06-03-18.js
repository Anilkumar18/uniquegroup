		...
		$.ajax({			   
			 ...
			 function productionregiontrigger()
			 {
			     ...
			     var ProductionRegions6 = $('#ProductionRegions6').val();
					  ...
					  var ProductionRegions7 = $('#ProductionRegions7').val();
					   ...
					   var ProductionRegions8 = $('#ProductionRegions8').val();
					   
					   var Hooks_ProductionRegions1=$('#Hooks_ProductionRegions1').val();
					   
					   var Hooks_ProductionRegions2=$('#Hooks_ProductionRegions2').val();
					   
					    var Hooks_ProductionRegions3=$('#Hooks_ProductionRegions3').val();
						
						var TissuePaper_ProductionRegions1=$("#TissuePaper_ProductionRegions1").val();
						
						var TissuePaper_ProductionRegions2=$("#TissuePaper_ProductionRegions2").val();
						
						var TissuePaper_ProductionRegions3=$("#TissuePaper_ProductionRegions3").val();
						
						var PackagingStickers_ProductionRegions1=$("#PackagingStickers_ProductionRegions1").val();
						
						var PackagingStickers_ProductionRegions2=$("#PackagingStickers_ProductionRegions2").val();
						
						var PackagingStickers_ProductionRegions3=$("#PackagingStickers_ProductionRegions3").val();
		  ...
		  $.ajax({
			...
			event.preventDefault();
				 ...
				 if(Hooks_ProductionRegions1!="")
				 {
				   $.ajax({
                    url:href+'/update_productsdetails/ajax/'+Hooks_ProductionRegions1,
				    type     : 'GET',
                    dataType: "json",
                    success:function(data) {
				...
				for(j=0;j<pLen;j++)
				{ 
				pscodehtml+='<div class="form-group"><div class="col-lg-5"><select style="margin-bottom:10px;" id="uniquefactory_hooks1" name="uniquefactory_hooks1[]" class="form-control  productionregion2"><option value="">Please select</option>';
			...
			event.preventDefault();
				  ...
				  if(Hooks_ProductionRegions2!="")
				 {
				   $.ajax({
                    url:href+'/update_productsdetails/ajax/'+Hooks_ProductionRegions2,
				    type     : 'GET',
                    dataType: "json",
                    success:function(data) {
				...
				for(j=0;j<pLen;j++)
				{ 
				pscodehtml+='<div class="form-group"><div class="col-lg-5"><select style="margin-bottom:10px;" id="uniquefactory_hooks2" name="uniquefactory_hooks2[]" class="form-control  productionregion2"><option value="">Please select</option>';
			...
			event.preventDefault();
				   ...
				   if(Hooks_ProductionRegions3!="")
				 {
				   $.ajax({
                    url:href+'/update_productsdetails/ajax/'+Hooks_ProductionRegions3,
				    type     : 'GET',
                    dataType: "json",
                    success:function(data) {
				...
				for(j=0;j<pLen;j++)
				{ 
				pscodehtml+='<div class="form-group"><div class="col-lg-5"><select style="margin-bottom:10px;" id="uniquefactory_hooks3" name="uniquefactory_hooks3[]" class="form-control  productionregion2"><option value="">Please select</option>';
			...
			event.preventDefault();
				 ...
				 /*Tissuepaper*/
				  if(TissuePaper_ProductionRegions1!="")
				 {
				   $.ajax({
                    url:href+'/update_productsdetails/ajax/'+TissuePaper_ProductionRegions1,
				    type     : 'GET',
                    dataType: "json",
                    success:function(data) {
				...
				for(j=0;j<pLen;j++)
				{ 
				pscodehtml+='<div class="form-group"><div class="col-lg-5"><select style="margin-bottom:10px;" id="uniquefactory_tissuepaper1" name="uniquefactory_tissuepaper1[]" class="form-control  productionregion2"><option value="">Please select</option>';
			...
			event.preventDefault();
				  ...
				  if(TissuePaper_ProductionRegions2!="")
				 {
				   $.ajax({
                    url:href+'/update_productsdetails/ajax/'+TissuePaper_ProductionRegions2,
				    type     : 'GET',
                    dataType: "json",
                    success:function(data) {
				...
				for(j=0;j<pLen;j++)
				{ 
				pscodehtml+='<div class="form-group"><div class="col-lg-5"><select style="margin-bottom:10px;" id="uniquefactory_tissuepaper2" name="uniquefactory_tissuepaper2[]" class="form-control  productionregion2"><option value="">Please select</option>';
			...
			event.preventDefault();
				  ...
				  if(TissuePaper_ProductionRegions3!="")
				 {
				   $.ajax({
                    url:href+'/update_productsdetails/ajax/'+TissuePaper_ProductionRegions3,
				    type     : 'GET',
                    dataType: "json",
                    success:function(data) {
				...
				for(j=0;j<pLen;j++)
				{ 
				pscodehtml+='<div class="form-group"><div class="col-lg-5"><select style="margin-bottom:10px;" id="uniquefactory_tissuepaper3" name="uniquefactory_tissuepaper3[]" class="form-control  productionregion2"><option value="">Please select</option>';
			...
			event.preventDefault();
				 ...
				 /*Packaging Stickers*/
				   ...
				   if(PackagingStickers_ProductionRegions1!="")
				 {
				   $.ajax({
                    url:href+'/update_productsdetails/ajax/'+PackagingStickers_ProductionRegions1,
				    type     : 'GET',
                    dataType: "json",
                    success:function(data) {
				...
				for(j=0;j<pLen;j++)
				{ 
				pscodehtml+='<div class="form-group"><div class="col-lg-5"><select style="margin-bottom:10px;" id="uniquefactory_packagingstickers1" name="uniquefactory_packagingstickers1[]" class="form-control  productionregion2"><option value="">Please select</option>';
			...
			event.preventDefault();
				  ...
				  if(PackagingStickers_ProductionRegions2!="")
				 {
				   $.ajax({
                    url:href+'/update_productsdetails/ajax/'+PackagingStickers_ProductionRegions2,
				    type     : 'GET',
                    dataType: "json",
                    success:function(data) {
				...
				for(j=0;j<pLen;j++)
				{ 
				pscodehtml+='<div class="form-group"><div class="col-lg-5"><select style="margin-bottom:10px;" id="uniquefactory_packagingstickers2" name="uniquefactory_packagingstickers2[]" class="form-control  productionregion2"><option value="">Please select</option>';
			...
			event.preventDefault();
				  ...
				  if(PackagingStickers_ProductionRegions3!="")
				 {
				   $.ajax({
                    url:href+'/update_productsdetails/ajax/'+PackagingStickers_ProductionRegions3,
				    type     : 'GET',
                    dataType: "json",
                    success:function(data) {
				...
				for(j=0;j<pLen;j++)
				{ 
				pscodehtml+='<div class="form-group"><div class="col-lg-5"><select style="margin-bottom:10px;" id="uniquefactory_packagingstickers3" name="uniquefactory_packagingstickers3[]" class="form-control  productionregion2"><option value="">Please select</option>';
		  ...
		  $.ajax({
			...
			/*Hooks when production regions change*/	
	   ...
	   $('select[name="PackagingStickers_ProductionRegions3"]').on('change', function() {
		  ...
		  $.ajax({
			...
			event.preventDefault();
												 ...
												 /*boxes insertions*/	
												 //Defect: client updations 
												 //Name: Bala-Util Team
												 //Desc. Printing finishing process dropdown provide as checkbox
							 ...
							 // alert(RawMaterial);
							  var PrintType=$("#PrintType").val();
							   var CuttingName=$("#CuttingName").val();
								...
								if ($('.printing:checked').length) {
								  var chkId = '';
								  $('.printing:checked').each(function () {
									chkId += $(this).val() + ",";
								  });
								 chkId = chkId.slice(0, -1);
								}
								//alert(chkId);
								var PrintingFinishingProcessName=chkId;
								...
								var ProductionRegions2=$("#ProductionRegions2").val();
								var ProductionRegions3=$("#ProductionRegions3").val();
								//var selectimageid3=$("#selectimageid3").val();
								//alert(selectimageid3);
				...
				//alert(data);
				/*$('#hiddenimgurlcpy').html('');
		var pp=$("#existingboximage").html();
		
	
		var $section = pp.clone(); 
		
		$('#hiddenimgurlcpy').html($section); */
