...
$('.FabricComposition').change(function() {
 	/*var title=$('#FabricComposition option:selected').text();
 	var processID=$('#FabricComposition option:selected').val();
 	alert(title);alert(processID);*/
 	var processhtml='';
 	$('.FabricComposition :selected').map(function(i,el){ 
 		processhtml+='<div class="col-lg-6"><input type="hidden" name="" id="" class="form-control" value="'+$(el).val()+'"><label><b>'+$(el).text()+'</b></label></div><div class="col-lg-6"><input type="text" name="" id="" class="form-control compositionblk" value="">%</div>';
 		//var title+=$(el).text();
 		//var processID+=$(el).val();
 	});
 	processhtml+='<div class="col-lg-6">Total</div><div class="col-lg-6"><input type="text" name="totalcompositionpercenatge" id="totalcompositionpercenatge" class="form-control totalcompositionpercenatge" value="">%<input type="hidden" id="percen100" class="percen100" value="100"></div>';
 	$('.fabriccompositionblk').html(processhtml);

 	$('.compositionblk').change(function(){
	var compositionpercentage=0;
$.each($('.compositionblk'), function(){ 
if($(this).val()){
...
$.each($('.printcolorhidden'), function(){
