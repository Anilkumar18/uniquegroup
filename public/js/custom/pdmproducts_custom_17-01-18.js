	  ...
	  $.ajax({			   
		...
		debugger;
			 ...
			 $.ajax({			   
				...
				{
					processtxtbox+='<tr><td>Field Name:</td></tr><tr class="gradeX"><td><input type="text" name="tablenamefield" id="tablenamefield" data-columnid="'+editproductid+'" class="tablecontent" readonly="readonly" value="'+editproductname+'" /><input type="hidden" name="selecthref" id="selecthref" value="'+$('#editproductid').html()+'" /></td><td><img  src="'+$('#assetimageedit').html()+'" onclick="fieldcolumnedit(this);" border="0"  title="Edit" class="editcontent"><span class="updatedropdownoptions"><img  src="'+$('#assetimageupdate').html()+'" border="0"  title="update" class="updatecontent" onclick="fnupdatecontent1(this);"></span><span class="deletedropdownoptions" data-href=""  data-valueid=""><img  src="'+$('#assetimagedelete').html()+'" border="0"  title="Delete" class="deletecontent" onclick="fndeletecontent1(this);"/></span><input type="hidden" name="selecthrefdelete" id="selecthrefdelete" value="'+$('#editproductid').html()+'" /></td></tr><tr><td>&nbsp;</td></tr>';
