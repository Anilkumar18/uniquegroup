...
function readURL3(input) {
	...
	$('.search_upload').datepicker({
	  ...
	  $("#seasonsubmit").click(function(){
	   ...
	   $('select[name="ProductionRegions3"]').on('change', function() {
		...
		$('select[name="TissuePaper_ProductionRegions1"]').on('change', function() {
			...
			if(ProductionRegions!="")
			{
			$('.uniquefactory_tissuepaper1').show();
		  $.ajax({
                    url: 'add_productsdetails/ajax/'+ProductionRegions,
                    type: "GET",
                    dataType: "json",
			...
			{
				$('.uniquefactory_tissuepaper1').hide();
			}
		...
		$('select[name="TissuePaper_ProductionRegions2"]').on('change', function() {
			...
			if(ProductionRegions!="")
			{
				$('.uniquefactory_tissuepaper2').show();
		  $.ajax({
                    url: 'add_productsdetails/ajax/'+ProductionRegions,
                    type: "GET",
                    dataType: "json",
			...
			{
			 $('.uniquefactory_tissuepaper2').hide();	
			}
	   ...
	   $('select[name="TissuePaper_ProductionRegions3"]').on('change', function() {
			...
			if(ProductionRegions!="")
			{
				$('.uniquefactory_tissuepaper3').show();
		  $.ajax({
                    url: 'add_productsdetails/ajax/'+ProductionRegions,
                    type: "GET",
                    dataType: "json",
			...
			{
				$('.uniquefactory_tissuepaper3').hide();
			}
	 ...
	 $('select[name="PackagingStickers_ProductionRegions1"]').on('change', function() {
			...
			if(ProductionRegions!="")
			{
				$('.uniquefactory_packagingstickers1').show();
		  $.ajax({
                    url: 'add_productsdetails/ajax/'+ProductionRegions,
                    type: "GET",
                    dataType: "json",
			...
			{
				 $('.uniquefactory_packagingstickers1').hide();
			}
    ...
    $('select[name="PackagingStickers_ProductionRegions2"]').on('change', function() {
			...
			if(ProductionRegions!="")
			{
				$('.uniquefactory_packagingstickers2').show(); 
		  $.ajax({
                    url: 'add_productsdetails/ajax/'+ProductionRegions,
                    type: "GET",
                    dataType: "json",
			...
			{
				$('.uniquefactory_packagingstickers2').hide(); 
			}
	 ...
	 $('select[name="PackagingStickers_ProductionRegions3"]').on('change', function() {
			...
			if(ProductionRegions!="")
			{
				$('.uniquefactory_packagingstickers3').show();
		  $.ajax({
                    url: 'add_productsdetails/ajax/'+ProductionRegions,
                    type: "GET",
                    dataType: "json",
			...
			{
				 $('.uniquefactory_packagingstickers3').hide();
			}
												 ...
												 /*boxes insertions*/	
		//Defect: client updations on 02-02-18
         //Name: Bala-Util Team
               ...
               $('#productgroups').css("display","block");
				if($("#Hook").is(':checked'))
				{
				 ...
				 $("#hookform").css("display","block");
				  ...
				  //$("#hookform").animate({ scrollTop: 0 }, 600);
				 //$("#hookform").scrollTop(0);
				  //$(window).scrollTop(0);
