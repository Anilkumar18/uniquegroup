...
class CreateFibrecontents extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fibrecontents', function (Blueprint $table) {
            $table->increments('id');
			$table->integer('chainID');
			$table->string('suspendedCarePhrase');
			$table->string('fibreContentsID');
    ...
    {
        Schema::dropIfExists('fibrecontents');
    }
}
