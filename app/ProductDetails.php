...
class ProductDetails extends Model
{
  ...
  protected $fillable = [
    'CustomerID','CustomerWareHouseID','HookID','TissuePaperID','PackagingStickersID','BoxID','ProductGroupID','ProductSubGroupID','SeasonID','ProductStatusID','ProductProcessID','ProductionRegionID1',
