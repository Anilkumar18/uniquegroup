...
class ProductDetails extends Model
{
  ...
  protected $fillable = [
    'CustomerID','CustomerWareHouseID','HookID','TissuePaperID','PackagingStickersID','BoxID','HangTagsID','TapesID','ZipperPullersID','ProductGroupID','ProductSubGroupID','SeasonID','ProductStatusID','ProductProcessID','ProductionRegionID1',
