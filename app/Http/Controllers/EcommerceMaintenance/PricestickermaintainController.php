...
class PricestickermaintainController extends Controller
{
 ...
 //}
 public function pricestickermaintanence(){
     $user = Auth::user();
      $usertype = UserType::where('id', '=', $user->userTypeID)->first();
    return view('ecommercemaintenance.pricestickermaintenance', compact('user','usertype'));
 }
