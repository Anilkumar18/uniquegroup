...
class CareInstructionsDryController extends Controller
{
	...
	public function DrySymbolList()
	{
	    ...
	    $symbollist=DB::select('call sp_selectcareInstructions(1,'.$customerid.',0,0,5,0)');	  
		
		$symbolimagelist=DB::select('call sp_selectcareInstructions(2,'.$customerid.',0,0,5,1)');
	  
	   //return view('admin.symbol',compact('chainSessionData','symbollist','user','usertype','symbolimagelist','chains'));
	 return view('ecommercemaintenance.careinstructions_dry',compact('symbollist','user','usertype','symbolimagelist','customers'));
	
	}

	public function addDrySymbollist(Request $request)
	  ...
	  public function DrySymbolactivate(Request $request)
		{
	 ...
	 public function DrySymboldeActivate(Request $request)
     {
...
public function DrySymbol_Select(Request $request,$id)
	{
