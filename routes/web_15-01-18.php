...
Route::post('/admin/pdmmaintenance/editdropdownoptions', 'Admin\ProductDetailsController@addDropdownOptions')->name('editdropdownoptions.edit');

Route::post('/admin/pdmmaintenance/deletedropdownoptions', 'Admin\ProductDetailsController@deletedropdownvalue')->name('deletedropdownoptions.delete');
