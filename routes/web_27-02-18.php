...
//marketing region
 ...
 Route::get('/duplicatedevelopment/{id}','DevelopmentListController@developmentlistduplicate')->name('user.developmentlistduplicate');
  ...
  Route::get('/developmentitemlist','DevelopmentItemListController@developmentlistviewdetails')->name('user.developmentlistview');
   ...
   Route::post('/developmentitemlisthook_delete/{id}', 'DevelopmentItemListController@deletehook')->name('user.developmentitemlistdeletehook');

   Route::post('/developmentitemlisttissue_delete/{id}', 'DevelopmentItemListController@deletetissue')->name('user.developmentitemlistdeletetissue');

   Route::post('/developmentitemlistpackage_delete/{id}', 'DevelopmentItemListController@deletepackage')->name('user.developmentitemlistdeletepackage');

     Route::get('/duplicatedevelopmentitem/{id}/{duplicateid?}','DevelopmentItemListController@developmentitemlistduplicate')->name('user.developmentitemlistduplicate');
