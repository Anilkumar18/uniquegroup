...
Route::get('/admin/vendorsdetails','Admin\VendorsController@vendorsdetailslist')->name('admin.vendorsdetails');
...
Route::post('/admin/vendoruser_delete/{id}', 'Admin\VendorUsersController@delete')->name('vendoruser.delete');
 ...
 Route::get('/admin/uniquefacilitydetails','Admin\UniqueController@uniquefacilitydetailslist')->name('admin.uniquefacilitydetails');
...
Route::post('/admin/add_productdetails','Admin\ProductDetailsController@addProductDetails')->name('admin.add_productdetails');
 ...
 Route::get('/admin/pdmmaintenance/productdevelopment/dashboard', 'Admin\ProductDevelopmentController@index')->name('admin.productdevelopmenthome');
  ...
  Route::post('/admin/pdmmaintenance/productdevelopment/addproductsdropdownoptions/{id}/edit', 'Admin\PdmProductgroupsController@DropdownOptionsSelect')->name('productsdropdownoptions.edit');
  
  Route::post('/admin/pdmmaintenance/productdevelopment/addproductsdropdownoptions/{id}/delete', 'Admin\ProductDevelopmentController@delete')->name('productsdropdownoptions.delete');
...
//marketing region
 ...
 // Route::get('newproducts/ajax/{id}','NewProductsController@myformAjax');
  ...
  Route::get('/products1','ProductsController@Productlistview')->name('user.products');
