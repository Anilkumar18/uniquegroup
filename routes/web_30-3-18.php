...
//symobol 
 ...
 Route::post('admin/dry/symbolist_activate','Admin\CareInstructionsDryController@DrySymbolactivate')->name('admin.drysymbolactive');
 
 Route::post('admin/dry/symbolist_deactivate/', 'Admin\CareInstructionsDryController@DrySymboldeActivate')->name('admin.drysymboldeactive');
 
 Route::post('admin/dry/symbolist_delete/', 'Admin\CareInstructionsDryController@delete')->name('admin.drysymboldelete');
