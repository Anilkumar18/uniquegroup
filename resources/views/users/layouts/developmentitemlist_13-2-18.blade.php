...
<script type="text/javascript">
   ...
   var href=$(this).data("href");
    ...
    $(".developmentitemduplicate").click(function(){ 
    
    var href=$(this).data("href");debugger
   //alert(href);
      var clonetr=$(this).parent().parent();
        $.ajax({
             ...
             {
                /*alert(data[0]["duplicate_id"]);
                alert(data[0]["edit_id"]);*/
                //$('#example1').html(data);
                //var message = JSON.parse(data);
                  debugger;
                 alert("inserted Successfully");

                //$(".developmentduplicate:last").clone().appendTo("#example1");
                 //alert(response);
