...
$requestdate=date('F j,Y',strtotime($productdetails->created_at));
 ...
 if($hangtagsdetails->id!="")
 {
	...
	$explodehangtagsuniquefactory1details=explode(",",$hangtagsdetails->UniqueFactory1);
	
	$explodehangtagsuniquefactory2details=explode(",",$hangtagsdetails->UniqueFactory2);
	
	$explodehangtagsuniquefactory3details=explode(",",$hangtagsdetails->UniqueFactory3);
	
	           if($hangtagsdetails->UniqueFactory1!="")
				  {
					  $uniquefactory1='';
				   foreach($explodehangtagsuniquefactory1details as $expuniquefactorydet){
				  ...
				  {
					  $uniquefactory2='';
				   foreach($explodehangtagsuniquefactory2details as $expuniquefactorydet){
				  ...
				  {
					  $uniquefactory3='';
				   foreach($explodehangtagsuniquefactory3details as $expuniquefactorydet){
...
<table width="595" border="0">
   ...
   if($boxesdetails->id!="")
 {
  ...
  <tr style="float:left; width:100%; height:auto;">
    <td style="height:460px;"><table style="width:100%; float:left;">            
   ...
   if($hookdetails->id!="")
 {
  ...
  <tr style="float:left; width:100%; height:150px;">
    <td style="height:270px;"><table style="width:100%; float:left;">            
            	<tr> <td style="font-size:11px; font-family:Arial; color:#00aeef; font-weight:bold; margin:0; margin-top:10px; line-height:14px;"> PRODUCT DETAILS </td> </tr>
                <tr>
                	<td style="float:left; width:100%; height:auto;"> 
                    	<table border="0" cellpadding="0" cellspacing="0" style="width: 100%; border:solid 1px #515151;">
   ...
   if($tissuepaperdetails->id!="")
 {
  ...
  <tr style="float:left; width:100%; height:auto">
    <td style="height:370px;"><table style="width:100%; float:left;">            
            	<tr> <td style="font-size:11px; font-family:Arial; color:#00aeef; font-weight:bold; margin:0; margin-top:10px; line-height:14px;"> PRODUCT DETAILS </td> </tr>
                <tr>
                	<td style="float:left; width:100%; height:auto;"> 
                    	<table border="0" cellpadding="0" cellspacing="0" style="width: 100%; border:solid 1px #515151;">
 ...
 <tr style="float:left; width:100%; height:auto;">
    ...
    <td><table style="width: 150px; height: 150px; float:left;">            
            	<tr> <td style="font-size:11px; font-family:Arial; color:#00aeef; font-weight:bold; margin:0; margin-top:10px; line-height:14px;">ART WORK</td> </tr>
                <tr>
                	<td style="float:left; width:100%; height:auto;"> 
                    	<table border="0" cellpadding="0" cellspacing="0">
              	<tr>
 ...
 ?>
 <tr style="float:left; width:100%; height:auto;">
    <td style="height:390px;"><table style="width:100%; float:left;">            
            	<tr> <td style="font-size:11px; font-family:Arial; color:#00aeef; font-weight:bold; margin:0; margin-top:10px; line-height:14px;"> PRODUCT DETAILS </td> </tr>
                <tr>
                	<td style="float:left; width:100%; height:auto;"> 
                    	<table border="0" cellpadding="0" cellspacing="0" style="width: 100%; border:solid 1px #515151;">
