   ...
   <input type="checkbox" name="gms" id="gms" value="gms" @if($boxesdetails->measurement2=="gms")checked="checked" @endif  class="thicknesschkbox"/><p class="spanval">gms</p>
    <input type="checkbox" name="mm" id="mm" value="mm" @if($boxesdetails->measurement3=="mm")checked="checked" @endif  class="thicknesschkbox"/><p class="spanval">mm</p>
                ...
                <label class="col-lg-2 control-label font-noraml text-left label_font">{{$list->fieldname}}:@if($list->isvalid==1)<span class="required">*</span>@endif</label>
                  ...
                  <div class="col-lg-5">
                 <input type="file" class="fbfile" name="imgInp3" id="imgInp3" value="{{$boxesdetails->Artwork}}" onchange="imageselect3();"/>
                ...
                <img id="blah3" src="storage/data/product/" alt="" width="80" height="80" /> <img id="blah3" 
                src="http://localhost:81/laravel/uniquegroup/storage/app/{{$boxesdetails->Artwork}}" alt="your image" width="80" height="80" />
                </div> 
  ...
  <div class="ibox float-e-margins">
      ...
      <div class="ibox-content">
        ...
        <form name="hooksadd" id="hooksadd" method="post" action="{{ url(route('user.addproductgroups')) }}" class="form-horizontal" enctype="multipart/form-data">
         ...
         <div id="imgcpy" style="display:block">
                ...
                <div class="printcolorhidden">
                 <label class="col-lg-2 control-label font-noraml text-left label_font">{{ $list->fieldname }}:@if($list->isvalid==1)<span class="required">*</span>@endif</label>
                   <div class="col-lg-5">
                        ...
                        <select id="Hook_factoryName" name="Hook_factoryName" class="form-control dropdownwidth">
                        <option value="">Please Select</option>
                         @foreach ($fielddetailslist as $fielddetails)
                           
                         <option value="{{$fielddetails->id}}" @if($hookdetails->UniqueFactory==$fielddetails->id)selected="selected" @endif>{{ $fielddetails->$fieldname }}</option>
                           @endforeach
    ...
    <input type="checkbox" name="mm" id="mm" value="mm" @if($hookdetails->measurement3=="mm")checked="checked" @endif  class="thicknesschkbox"/><p class="spanval">mm</p>
                ...
                <label class="col-lg-2 control-label font-noraml text-left label_font">{{$list->fieldname}}:@if($list->isvalid==1)<span class="required">*</span>@endif</label>
                 ...
                 <input type="hidden" name="selectimage" id="selectimage" class="form-control selectimage" value="{{$hookdetails->Artwork}}" readonly="readonly">
                  <input type="hidden" name="selectimageid" id="selectimageid" class="form-control" value="{{$hookdetails->id}}" readonly="readonly">
                  </div>
                ...
                <img id="blah" src="storage/data/product/" alt="" width="80" height="80" /> <img id="blah" 
                src="http://localhost:81/laravel/uniquegroup/storage/app/{{$hookdetails->Artwork}}" alt="your image" width="80" height="80" />
                </div> 
            ...
            <div class="col-sm-12 b-r">
             @foreach($productdevelopmentsubgroupdetails as $list)
              ...
              <div class="form-group frmgroup">
				...
				$listoffieldname=$list->fieldname;
				?>
               @if($fieldname=="factoryName")
                <div class="printcolorhidden">
                 <label class="col-lg-2 control-label font-noraml text-left label_font">{{ $list->fieldname }}:@if($list->isvalid==1)<span class="required">*</span>@endif</label>
                   <div class="col-lg-5">
                
                        <select id="Tissuepaper_factoryName" name="Tissuepaper_factoryName" class="form-control dropdownwidth">
                        <option value="">Please Select</option>
                         @foreach ($fielddetailslist as $fielddetails)
                           
                         <option value="{{$fielddetails->id}}" @if($tissuepaperdetails->UniqueFactory==$fielddetails->id)selected="selected" @endif>{{ $fielddetails->$fieldname }}</option>
                           @endforeach
    ...
    <input type="checkbox" name="mm" id="mm" value="mm" @if($tissuepaperdetails->measurement3=="mm")checked="checked" @endif  class="thicknesschkbox"/><p class="spanval">mm</p>
           ...
           @elseif($list->columnfieldname=="tissuepaper_print_color6")
              ...
              <div class="printcolorhidden" style="display:none;overflow:hidden;" id="tissueprintcolor8">
                ...
                <img id="blah1" src="http://localhost:81/laravel/uniquegroup/storage/app/{{$tissuepaperdetails->Artwork}}" alt="your image" width="80" height="80" />
                </div> 
                ...
                <div class="printcolorhidden">
                 <label class="col-lg-2 control-label font-noraml text-left label_font">{{ $list->fieldname }}:@if($list->isvalid==1)<span class="required">*</span>@endif</label>
                   <div class="col-lg-5">
                        ...
                        <select id="Package_factoryName" name="Package_factoryName" class="form-control dropdownwidth">
                        <option value="">Please Select</option>
                         @foreach ($fielddetailslist as $fielddetails)
                           
                         <option value="{{$fielddetails->id}}" @if($packagingstickersdetails->UniqueFactory==$fielddetails->id)selected="selected" @endif>{{ $fielddetails->$fieldname }}</option>
                           @endforeach
    ...
    <input type="checkbox" name="mm" id="mm" value="mm" @if($packagingstickersdetails->measurement3=="mm")checked="checked" @endif  class="thicknesschkbox"/><p class="spanval">mm</p>
           ...
           @elseif($list->columnfieldname=="packageprint_color6")
              ...
              <div class="printcolorhidden" style="display:none;overflow:hidden;" id="packageprintcolor8">
                ...
                <img id="blah2" src="http://localhost:81/laravel/uniquegroup/storage/app/{{$packagingstickersdetails->Artwork}}" alt="your image" width="80" height="80" />
                </div> 
                 </div>
