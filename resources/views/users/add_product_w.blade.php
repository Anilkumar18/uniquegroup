             ...
             @endif   
               ...
               <div class="col-lg-5 addr_field">
                ...
                <option value="">Please Select</option>
                 ...
                 @elseif($listoffieldname=="SubGroup")
                ...
                @else
				 ...
				 ?>
                          @if($version!="")
                       <input type="text" name="{{$list->columnfieldname}}" id="{{$list->columnfieldname}}" value="<?php echo $version; ?>" class="form-control" readonly="readonly"/>                      @else
