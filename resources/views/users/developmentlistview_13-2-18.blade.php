...
<div class="col-lg-12">
                ...
                <div class="ibox float-e-margins">
                    ...
                    //print_r($artworkphoto);
                      ...
                      <tr class="gradeX">
                        ...
                        <td><img src="{{ route('user.productpic', ['id' => $list->id]) }}" width="100"/></td>
                        ...
                        <span class="developmentitemduplicate" data-href="{{ url(route('user.developmentitemlistduplicate', ['id' => $list->id.'/'.'0'])) }}" ><a href="javascript:;"><img  src="{{ asset('/img/file.png') }}" border="0"  title="Duplicate"/></a></span>                      

                        <span class=""><a href="{{ url(route('user.developmentitemproductdetails', ['id' => $list->id.'/'.'0'])) }}"><img  src="{{ asset('/img/view.png') }}" border="0"  title="View"/></a></span> 
             ...
             ?></td>
                        ...
                        <td><img src="{{ route('user.producthookpic', ['id' => $list->HookID]) }}" width="100"/></td>
                        ...
                        <span class="developmentitemduplicate" data-href="{{ url(route('user.developmentitemlistduplicate', ['id' => $list->id.'/'.'1'])) }}" ><a href="javascript:;"><img  src="{{ asset('/img/file.png') }}" border="0"  title="Duplicate"/></a></span>                      

                        <span class=""><a href="{{ url(route('user.developmentitemproductdetails', ['id' => $list->id.'/'.'1'])) }}"><img  src="{{ asset('/img/view.png') }}" border="0"  title="View"/></a></span> 

                        <span class="deletedevelopmentitemlist" data-href="{{ url(route('user.developmentitemlistdeletehook', ['id' => $list->HookID])) }}"><a href="javascript:;"><img  src="{{ asset('/img/delete.png') }}" border="0"  title="Delete"/></a></span>
                        </td>
             ...
             ?></td>
                        ...
                        <td><img src="{{ route('user.productpictissue', ['id' => $list->TissuePaperID]) }}" width="100"/></td>
                        ...
                        <span class="developmentitemduplicate" data-href="{{ url(route('user.developmentitemlistduplicate', ['id' => $list->id.'/'.'2'])) }}" ><a href="javascript:;"><img  src="{{ asset('/img/file.png') }}" border="0"  title="Duplicate"/></a></span>                      

                        <span class="selectuniqueusers"><a href="{{ url(route('user.developmentitemproductdetails', ['id' => $list->id.'/'.'2'])) }}"><img  src="{{ asset('/img/view.png') }}" border="0"  title="View"/></a></span> 

                        <span class="deletedevelopmentitemlist" data-href="{{ url(route('user.developmentitemlistdeletetissue', ['id' => $list->TissuePaperID])) }}"><a href="javascript:;"><img  src="{{ asset('/img/delete.png') }}" border="0"  title="Delete"/></a></span>
                        </td>
             ...
             ?></td>
                        ...
                        <td><img src="{{ route('user.productpicpackage', ['id' => $list->PackagingStickersID]) }}" width="100"/></td>
                        ...
                        <span class="developmentitemduplicate" data-href="{{ url(route('user.developmentitemlistduplicate', ['id' => $list->id.'/'.'3'])) }}" ><a href="javascript:;"><img  src="{{ asset('/img/file.png') }}" border="0"  title="Duplicate"/></a></span>                      

                        <span class="selectuniqueusers"><a href="{{ url(route('user.developmentitemproductdetails', ['id' => $list->id.'/'.'3'])) }}"><img  src="{{ asset('/img/view.png') }}" border="0"  title="View"/></a></span> 

                        <span class="deletedevelopmentitemlist" data-href="{{ url(route('user.developmentitemlistdeletepackage', ['id' => $list->PackagingStickersID])) }}"><a href="javascript:;"><img  src="{{ asset('/img/delete.png') }}" border="0"  title="Delete"/></a></span>
                        </td>
