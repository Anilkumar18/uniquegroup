...
<div class="row border-bottom white-bg notificationdiv">
                   ...
                   <br />
                    <ol class="breadcrumb">
                      ...
                      <li>Update Development ItemList<strong></strong></li>
                      <li>Product details</li>
                      <li>Boxes</li>
                      <li>
                      @if($producttype==0)
                       
                       {{$productsubgroupdetails->ProductSubGroupName}}
...
<div class="row wrapper wrapper-content animated fadeInRight" id="boxform">
  ...
  <div class="ibox float-e-margins">
      ...
      <div class="ibox-content">
        ...
        <!--form name="productdetailsadd" id="productdetailsadd" method="post" action="{{ url(route('user.add_productsgroupdetails')) }}" class="form-horizontal" enctype="multipart/form-data"-->
         <form name="productdetailsadd" id="productdetailsadd" method="post"  class="form-horizontal" enctype="multipart/form-data" action="{{ url(route('user.updateboxitemlist')) }}">
         {{ csrf_field() }}
         
         

          <input type="hidden" name="editID" id="editID" value="{{$boxesdetails->id}}"  />
          <input type="hidden" name="customerid" id="customerid" value="{{$customers->id}}"  />
   ...
   <input type="checkbox" name="gms" id="gms" value="gms" @if($boxesdetails->measurement2=="gms")checked="checked" @endif  class="thicknesschkbox"/><p class="spanval">gms</p>
    ...
    <div class="form-group">
             ...
             <!-- <a data-href="{{ url('/') }}" data-selecthref="" value="1"  title="test"
                  ...
                  <input type="submit" name="submit" id=""  value="Update" class="button" style="width: 12%;"/>
...
<div class="row wrapper wrapper-content animated fadeInRight" id="productgroups">
  ...
  <div class="ibox float-e-margins">
      ...
      <div class="ibox-content">
        ...
        <div class="table-responsive" style="overflow:hidden">
        <form name="hooksadd" id="hooksadd" method="post" action="{{ url(route('user.updateitemlist')) }}" class="form-horizontal" enctype="multipart/form-data">
         {{ csrf_field() }}
         
         <div id="imgcpy" ></div>
         
         <div id="hiddenimgurlcpy" ></div>
           ...
           Desc. Get the productid,groupid,subgroupid-->
         
         
          <input type="hidden" name="editID" id="editID" value="{{$hookdetails->id}}"  />
          
           <input type="hidden" name="productID" id="productID" value="{{$hookdetails->ProductID}}">
               <input type="hidden" name="ProductGroupID" id="ProductGroupID" value="{{$hookdetails->ProductGroupID}}">
               <input type="hidden" name="ProductSubGroupID" id="ProductSubGroupID" value="{{$hookdetails->ProductSubGroupID }}">
               <input type="hidden" name="customerid" id="customerid" value="{{$hookdetails->CustomerID}}"  />
...
<!--Tissuepaper-->
            ...
            <div class="col-lg-12" id="tissuepaperform" >
             ...
             <input type="hidden" name="tissuepapereditID" id="tissuepapereditID" value="{{$tissuepaperdetails->id}}"  />
              ...
              <input type="hidden" name="productID" id="productID" value="{{$tissuepaperdetails->ProductID}}">
               <input type="hidden" name="ProductGroupID" id="ProductGroupID" value="{{$tissuepaperdetails->ProductGroupID}}">
               <input type="hidden" name="ProductSubGroupID" id="ProductSubGroupID" value="{{$tissuepaperdetails->ProductSubGroupID }}">
               <input type="hidden" name="customerid" id="customerid" value="{{$tissuepaperdetails->CustomerID}}"  />
   ...
   <input type="checkbox" name="gms" id="gms" value="gms" @if($tissuepaperdetails->measurement2=="gms")checked="checked" @endif  class="thicknesschkbox"/><p class="spanval">gms</p>
    <input type="checkbox" name="mm" id="mm" value="mm" @if($tissuepaperdetails->measurement3=="mm")checked="checked" @endif  class="thicknesschkbox"/><p class="spanval">mm</p>
           ...
           Desc. Get the productid,groupid,subgroupid-->
               ...
               <input type="hidden" name="productID" id="productID" value="{{$packagingstickersdetails->ProductID}}">
               <input type="hidden" name="ProductGroupID" id="ProductGroupID" value="{{$packagingstickersdetails->ProductGroupID}}">
               <input type="hidden" name="ProductSubGroupID" id="ProductSubGroupID" value="{{$packagingstickersdetails->ProductSubGroupID }}">
               <input type="hidden" name="customerid" id="customerid" value="{{$packagingstickersdetails->CustomerID}}"  />
   ...
   <input type="checkbox" name="gms" id="gms" value="gms" @if($packagingstickersdetails->measurement2=="gms")checked="checked" @endif  class="thicknesschkbox"/><p class="spanval">gms</p>
    ...
    <div class="form-group">
              ...
              <!--  <a data-href="{{ url('/') }}" data-selecthref="" value="1"  title="test"
                  data-id="1" class="button"/>Next</a>-->
                  <input type="submit" id="submit" value="Update"  class="button" style="width: 12%;"/>
                </div>
                 <div class="col-lg-8">
