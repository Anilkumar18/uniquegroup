@extends('users.layouts.pdmproducts')
<?php
error_reporting(0);
?>
@section('content')
...
<h5> >Products-<?php echo $productgroupdetails->ProductGroup;?>-<?php echo $productsubgroupdetails->ProductSubGroupName;?> Table</h5>
</div>
...
<div class="wrapper wrapper-content animated fadeInRight">
                        ...
                        <tr class="gradeX">
                         ...
                         @if($listofcolunmns->popup==1 && $listofcolunmns->status==1)
                            ...
                            <td>
                              ...
                              <a data-href="{{ url('/') }}" data-selecthref="{{ url(route('productsdropdownoptions.edit', ['id' => $listofcolunmns->id])) }}" data-valueid="{{ $listofcolunmns->fieldname }}" href="javascript:;"  class="showfieldnames" data-id="{{ $listofcolunmns->id }}" data-toggle="modal" data-target="#myModal"> <img  src="{{ asset('/img/edit.png') }}" border="0"  title="Edit" style="width:9%"/></a>
                              
                              
                                <span class="deletemaingroupdelete" data-href="{{ url(route('listofproducts.delete', ['id' => $listofcolunmns->id])) }}"  data-valueid="{{ $listofcolunmns->id }}"><a href="javascript:;"> <img  src="{{ asset('/img/delete.png') }}" border="0"  title="Delete" class="productdevelopmentdelete" /></a></span>
                            </td>
                          @else
                             <td>
                            ...
                            {{$listofcolunmns->fieldname}}
                              ...
                              <a data-href="{{ url('/') }}" data-selecthref="{{ url(route('fieldnamelist.select', ['id' => $listofcolunmns->id])) }}"  href="javascript:;" class="editfieldnames" data-id="{{ $listofcolunmns->id }}" data-toggle="modal" data-target="#myModal1"><img  src="{{ asset('/img/edit.png') }}" border="0"  title="Edit" style="width:9%"/></a>
                            ...
                            <div class="modal inmodal" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
                                ...
                                <div class="modal-content animated bounceInRight">
                                    ...
                                    <div class="chain_bg">
                                      ...
                                      <form name="dropdownoptionsadd" id="dropdownoptionsadd" method="post" action="{{ url(route('users.updateallfieldnames',['id'=>$productgroupdetails->id])) }}" class="form-horizontal">   
                                     @else
                                     <form name="dropdownoptionsadd" id="dropdownoptionsadd" method="post" action="{{ url(route('users.updateallfieldnames',['id'=>$productsubgroupdetails->id])) }}" class="form-horizontal">   
                                     @endif
                                        ...
                                        @if($productsubgroupdetails->id==0 || $productsubgroupdetails->id=="")
                                     <span id="editproductid" style="display:none;">{{ url(route('users.addfieldnames',['id'=>$productgroupdetails->id]))}}</span>
                                  <!--   <span id="deleteproductid" style="display:none;">{{ url(route('listofproducts.delete',['id'=>$productgroupdetails->id]))}}</span>-->
                                   <span id="deleteproductid" style="display:none;">{{ url(route('productsdropdownoptions.deletedropdownvaluetablename'))}}</span>
                                     @elseif($productsubgroupdetails->id!="")
                                       <span id="editproductid" style="display:none;">{{ url(route('users.addfieldnames',['id'=>$productsubgroupdetails->id]))}}</span>
                              ...
                              <span id="assetimageedit" style="display: none;">{{ asset('/img/edit.png') }}</span>
 ...
 <div class="modal inmodal" id="myModal1" tabindex="-1" role="dialog" aria-hidden="true">
                             ...
                             @if($productsubgroupdetails->id==0 || $productsubgroupdetails->id=="")
                                     <form name="updatefieldsnames" id="updatefieldsnames" method="post" action="{{ url(route('users.addfieldnames',['id'=>$productgroupdetails->id]))}}" class="form-horizontal">  
                                     @else
                                     <form name="updatefieldsnames" id="updatefieldsnames" method="post" action="{{ url(route('users.addfieldnames',['id'=>$productsubgroupdetails->id]))}}" class="form-horizontal"> 
                                     @endif
