      ...
      <input type="hidden" name="productsubgroupurl" id="productsubgroupurl" value="<?php echo url('/');?>" />
        ...
        ?>
                ...
                <option value="">Please Select</option>
                 ...
                 <!-- sathish 16-03-2018 worked other season name -->
                      <?php 
if ($productdetails->SeasonID==5) {
 ?><input type="text" name="otherSeason" value="{{$productdetails->Season}}" id="otherseason">
 <?php }
 ?>
                </div>
                </div>
                ...
                <div class="printcolorhidden">
                 <label class="col-lg-2 control-label font-noraml text-left label_font">{{ $list->fieldname }}:@if($list->isvalid==1)<span class="required">*</span>@endif</label>
                   <div class="col-lg-5">
                        ...
                        <?php  
                        $arrFinishingProcessName=explode(',',$boxesdetails->PrintingFinishingProcessID); ?>
                          @foreach ($fielddetailslist as $fielddetails)
             ...
             @elseif($list->columnfieldname=="Tissue_samplecost")
              <div class="printcolorhidden" style="display:none;overflow:hidden;" id="printcolor8">
                <label class="col-lg-2 control-label font-noraml text-left label_font">{{ $list->fieldname }}:@if($list->isvalid==1)<span class="required">*</span>@endif</label>
                 <div class="col-lg-5">
                     <input type="text" name="{{$list->columnfieldname}}" id="{{$list->columnfieldname}}"
                     value="{{$boxesdetails->Tissue_Samplecost}}"   class="form-control" />
                 </div>
             </div>
             @elseif($list->columnfieldname=="Pack_samplecost")
              <div class="printcolorhidden" style="display:none;overflow:hidden;" id="printcolor8">
                <label class="col-lg-2 control-label font-noraml text-left label_font">{{ $list->fieldname }}:@if($list->isvalid==1)<span class="required">*</span>@endif</label>
                 <div class="col-lg-5">
                     <input type="text" name="{{$list->columnfieldname}}" id="{{$list->columnfieldname}}"
                     value="{{$boxesdetails->Pack_Samplecost}}"   class="form-control" />
                 </div>
             </div>
...
<!-- Vidhya:PHP
//Create a edit function for hangtags product -->
@elseif(isset($hangtagsproduct->id))
<?php if(isset($hangtagsproduct->id)) {?>
<?php $otherproduct=0; ?>  
...
<!-- Tapes:Edit -->
@elseif(isset($tapeproduct->id))
<?php if(isset($tapeproduct->id)) {?>
<?php $otherproduct=0; ?>  

<h4 style="color:#00ADEF;"><strong>TAPES DETAILS</strong></h4>
...
<?php } ?>
<!-- Zipperpullers edit -->
@elseif(isset($zipperpullerproduct->id))
<?php if(isset($zipperpullerproduct->id)) {?>
<?php $otherproduct=0; ?> 
      ...
      <div class="ibox-content">
        ...
        ?>
               ...
               //ADd 2 fields -->
                ...
                @elseif($fieldname=="Sample Costing")
                    <div class="printcolorhidden">
                 <label class="col-lg-2 control-label font-noraml text-left label_font">{{ $list->fieldname }}:@if($list->isvalid==1)<span class="required">*</span>@endif</label>
                 <div class="col-lg-5">
...
<!-- sathish 15-03-2018 -->
   ...
   <input type="radio" name="hook_measurement" id="gms" value="gms" @if($hookdetails->measurement1=="gms")checked="checked" @endif  class="thicknesschkbox"/><p class="spanval">gms</p> -->
    <input type="radio" name="hook_measurement" id="mm" value="mm" @if($hookdetails->measurement1=="mm")checked="checked" @endif  class="thicknesschkbox"/><p class="spanval">mm</p>
             ...
             <?php } ?>
@elseif(isset($tissuepaperdetails->id))
...
// sathish 16-03-2018
        //work tissueprintingfinishingprocess
        ...
        ?>
                ...
                <?php $arrFinishingProcessName=explode(',', $tissuepaperdetails->PrintingFinishingProcessID); ?>
                         ...
                         @foreach ($fielddetailslist as $fielddetails)
                           <div class="col-lg-12">
                            <!-- sathish work Tissuepaper_PrintingFinishingProcess -->
              <input type="checkbox" name="Tissuepaper_PrintingFinishingProcess[]" id="Tissuepaper_PrintingFinishingProcess" value="{{$fielddetails->id}}"  
              class="thicknesschkbox printing" <?php
        if(in_array($fielddetails->id,$tissueprintingcheckbox))
        {
        echo "checked=checked";  
        }
        ...
        @elseif($listoffieldname=="Unique Factory 3")
          ...
          $chkvalexp=explode(",",$chkval);
          ?>
               <!-- sathish 14-02-2018 -->   <input type="radio" name="tissue_measurement" id="pt" value="pt" @if($tissuepaperdetails->measurement1=="pt")checked="checked" @endif  class="thicknesschkbox"/><p class="spanval">pt</p>
    ...
    <input type="radio" name="tissue_measurement" id="mm" value="mm" @if($tissuepaperdetails->measurement1=="mm")checked="checked" @endif  class="thicknesschkbox"/><p class="spanval">mm</p>
           ...
           @elseif($list->columnfieldname=="tissuepaper_print_color6")
              ...
              <div class="printcolorhidden" style="display:none;overflow:hidden;" id="tissueprintcolor8">
               ...
               //Vidhya: PHP Team
               //ADd 2 fields -->
                  @elseif($listoffieldname=="TissuePaper Currency")
            ...
            <?php } ?>
@elseif(isset($packagingstickersdetails->id))
...
<?php $otherproduct=0; ?>  
        ...
        $listoffieldname=$list->fieldname;
         ...
         //Defect: checkbox issue
                       //Name: Sathish-PHP Team
                        //Working for the packagin sticker 
        ...
        @elseif($listoffieldname=="Unique Factory 1")
                ...
                <option value="">Please Select</option>
                 ...
                 <input type="hidden" id="SelPackagingStickersUniquefactory1" name="SelPackagingStickersUniquefactory1" class="SelUniquefactory" value="{{$packagingstickersdetails->UniqueFactory1}}" />
                </div>
                 @elseif($listoffieldname=="Production Region 2")
                <div class="printcolorhidden">
                 <label class="col-lg-2 control-label font-noraml text-left label_font">{{ $list->fieldname }}:@if($list->isvalid==1)<span class="required">*</span>@endif</label>
...
<!-- //Defect: checkbox 16-03-2018
                       //Name: Sathish-PHP Team
                        //Working packaginstickers checkbox -->
                         @foreach ($fielddetailslist as $fielddetails)
                          <div class="col-lg-12">
              ...
              <?php
        if(in_array($fielddetails->id,$packageprintingcheckbox))
        {
        echo "checked=checked";  
        }
          ?>
              ...
              <div class="printcolorhidden" style="display:none;overflow:hidden;" id="packageprintcolor8">
                ...
                <label class="col-lg-2 control-label font-noraml text-left label_font">{{$list->fieldname}}:@if($list->isvalid==1)<span class="required">*</span>@endif</label>
                 ...
                 <input type="hidden" name="selectimage2" id="selectimage2" class="form-control selectimage2"
                  ...
                  <input type="hidden" name="selectimageid2" id="packagelist_selectimage" class="form-control" readonly="readonly">
                  </div>
...
<?php if($otherproduct==1 && (isset($hookdetails->id) || isset($tissuepaperdetails->id) || isset($packagingstickersdetails->id))){ ?>  
  ...
  <div class="ibox float-e-margins">
      ...
      <div class="ibox-content">
        ...
        ?>
                ...
                <!-- Defect no: pdf march 05: page:11
                //Vidhya:php
                //Add 2 fields for edit -->
                @elseif($listoffieldname=="Hook Currency")
                 <div class="printcolorhidden">
                 <label class="col-lg-2 control-label font-noraml text-left label_font">{{ $list->fieldname }}:@if($list->isvalid==1)<span class="required">*</span>@endif</label>
                   <div class="col-lg-5">
        ...
        @elseif($listoffieldname=="Unique Factory 2")
          ...
          $chkvalexp=explode(",",$chkval);
          ?>
          <!-- sathish 15-03-2018 button name -->
          <!-- Defect No:57
          //Vidhya:PHP team
          //Remove gms,pt radio button -->
                  <!-- <input type="radio" name="hook_measurement" id="pt" value="pt" @if($hookdetails->measurement1=="pt")checked="checked" @endif  class="thicknesschkbox"/><p class="spanval">pt</p>
   <input type="radio" name="hook_measurement" id="gms" value="gms" @if($hookdetails->measurement1=="gms")checked="checked" @endif  class="thicknesschkbox"/><p class="spanval">gms</p> -->
    <input type="radio" name="hook_measurement" id="mm" value="mm" @if($hookdetails->measurement1=="mm")checked="checked" @endif  class="thicknesschkbox"/><p class="spanval">mm</p>
                  @endif
             ...
             <?php }
             if(isset($tissuepaperdetails->id)) {?>
<!--Tissuepaper-->
                 ...
                 <label class="col-lg-2 control-label font-noraml text-left label_font">{{ $list->fieldname }}:@if($list->isvalid==1)<span class="required">*</span>@endif</label>
                   <div class="col-lg-5">
                        ...
                        <?php $arrFinishingProcessName=explode(',', $tissuepaperdetails->PrintingFinishingProcessID); ?>
                         @foreach ($fielddetailslist as $fielddetails)
                           <div class="col-lg-12">
 <!-- sathish worked 16-03-2018  -->
              <input type="checkbox" name="Tissuepaper_PrintingFinishingProcess[]" id="Tissuepaper_PrintingFinishingProcess" value="{{$fielddetails->id}}" class="thicknesschkbox printing"   <?php
        if(in_array($fielddetails->id,$tissueprintingcheckbox))
        {
        echo "checked=checked";  
        } ?> /><p class="spanval label_font" > {{$fielddetails->$fieldname}}</p>
        ...
        @elseif($listoffieldname=="Unique Factory 3")
             ...
             <div class="printcolorhidden">
                 ...
                 <div class="col-lg-5">
                      ...
                      <input type="text" name="Tissuepaper_QualityReference" id="Tissuepaper_QualityReference" value="{{$tissuepaperdetails->QualityReference}}" class="form-control qty_refbtn"/>                   <!-- sathish 15-03-2018 -->
                  <input type="checkbox" name="tissueqty_chk" id="tissueqty_chk" class="qty_checkbox" value="1" @if($tissuepaperdetails->QualityReferencem==1) checked="checked" @endif />
                    @if($list->checkboxvalue!="")
                    <p  class="aspersample">{{$list->checkboxvalue}}</p>
                       @endif
          ...
          $chkvalexp=explode(",",$chkval);
          ?>
          <!-- sathish 15-03-2018 radio button name -->
 ...
 <!-- //Defect: checkbox 16-03-2018
                 ...
                 <?php $arrFinishingProcessName=explode(',', $packagingstickersdetails->PrintingFinishingProcessID); ?>
                         ...
                         @foreach ($fielddetailslist as $fielddetails)
                           <div class="col-lg-12">
              <input type="checkbox" name="Package_PrintingFinishingProcess[]" id="Package_PrintingFinishingProcess" value="{{$fielddetails->id}}" class="thicknesschkbox printing" <?php
        if(in_array($fielddetails->id,$packageprintingcheckbox))
        {
        echo "checked=checked";  
        }
...
<?php } ?> <!-- sathish -->
            ...
            @foreach($inven_productfielddetails as $list)
                ...
                $fielddetailslist1 = DB::table("uniqueoffices")->get();
                ...
                <label class="col-lg-2 control-label font-noraml text-left label_font">{{$list->fieldname}}:@if($list->isvalid==1)<span class="required">*</span>@endif</label>
                     <div class="col-lg-5  invwidth">
                      <select  name="inventory{{$fieldname}}<?php echo $i; ?>" id="{{$fieldname}}<?php echo $i; ?>" class="form-control inventoryregionselect">
                               ...
                               <option value="{{$fielddetails->id}}" @if($productinventorydetails->ProductionRegionID1==$fielddetails->id)selected="selected" @endif>
...
<option value="">Please Select</option>
                  ...
                  <input type="hidden" id="SelUniquefactory1" class="SelUniquefactory" name="SelUniquefactory1" value="{{$productinventorydetails->UniqueFactory1}}" /> 
                ...
                <label class="col-lg-2 control-label font-noraml text-left label_font">{{$list->fieldname}}:@if($list->isvalid==1)<span class="required">*</span>@endif</label>
                     <div class="col-lg-5  invwidth">
                      <select  name="inventory{{$fieldname}}2" id="{{$fieldname}}2" class="form-control inventoryregionselect" >
                               ...
                               <option value="{{$fielddetails->id}}" @if($productinventorydetails->ProductionRegionID2==$fielddetails->id)selected="selected" @endif>
                ...
                <label class="col-lg-2 control-label font-noraml text-left label_font">{{$list->fieldname}}:@if($list->isvalid==1)<span class="required">*</span>@endif</label>
                     <div class="col-lg-5  invwidth">
                      <select  name="inventory{{$fieldname}}3" id="{{$fieldname}}3" class="form-control inventoryregionselect" >
                               ...
                               <option value="{{$fielddetails->id}}" @if($productinventorydetails->ProductionRegionID3==$fielddetails->id)selected="selected" @endif>
...
<input type="hidden" id="SelUniquefactory1" class="SelUniquefactory" name="SelUniquefactory1" value="{{$productinventorydetails->UniqueFactory1}}" />  
    ...
    $costrequiredetails=explode("#",$costseleteddetails);
      ...
      <!-- sathish 25-03-2018  remove disables--> 
                     <label class="col-lg-2 control-label font-noraml text-left label_font">Currency</label>
                    <div class="col-lg-5 divwidthforexworks">
                    <select style="margin-top: 13%;" @if($usertype->id==9) disabled="disabled" @endif>
                     <option value="">Please Select</option>
                 @foreach ($fielddetailslist as $fielddetails)
                 <option value="{{$fielddetails->id}}" @if($productquotedetails->CurrencyID==$fielddetails->id)selected="selected" @endif>{{ $fielddetails->$fieldname }}</option>
                   @endforeach 
...
<div>  Margin :</div>  <div class="col-sm-12 b-r">
              <span class="required">*</span><input type="text" class="quantitychk1 margin123" name="input0" id="input0"  onkeyup="margin(this)" value="{{$productdetails->Margin}}">%
            @foreach($invendetails_productfielddetails as $list)
