...
<div class="row border-bottom white-bg notificationdiv">
  ...
  <div class="ibox float-e-margins">
      ...
      <div class="ibox-content">
        ...
        <form name="forgetpassword" id="forgetpassword" method="post" action="{{ url(route('user.sendhtmlemail',['id'=>$productdetails->id])) }}"  
         ...
         {{ csrf_field() }}
            ...
            <?php
			//echo "hangtagsid".$hangtagsdetails->id; exit;
			?>
