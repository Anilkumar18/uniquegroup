            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    <a href="{{ url(route('dashboard'))  }}"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboards</span></a>
                      ...
                      @if ($usertype->id ==7 || $usertype->id==12 || $usertype->id==13)             
                        <li>
                         ...
                         @elseif($usertype->id ==9)
                        
                         
                           <li class="<?php echo $productdetails;?>"><a href="javascript:;"><span class="nav-label">New Development</span><span class="fa arrow"></span></a>
                           <ul class="nav nav-second-level collapse">
                             @foreach($productgrouplist as $groupdetails)
                            <li><a href="{{url(route('user.products',['id'=>$groupdetails->id]))}}">{{$groupdetails->ProductGroup}}</a></li>
                            @endforeach
                           </ul>
                            <li class=""><a href="{{url(route('user.developmentlist')) }}">Development List</a></li>
                            <li class=""><a href="{{url(route('user.developmentlistview')) }}">Development Item List</a></li>
