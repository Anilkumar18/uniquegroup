...
if($productdetails->HangTagsID!=0)
{
	...
	$hangtagsdetails=App\HangTags::where('id','=',$productdetails->HangTagsID)->where('status','=',1)->first();
...
if($productdetails->ZipperPullersID!=0)
{
	 
	 $zipperdetails=App\ZipperPullers::where('id','=',$zipperdetails->id)->where('status','=',1)->first();
...
if($productdetails->WovenLabelID!=0)
{
...
/*vidhya:09-04-2018*/
if($productdetails->PrintedLabelID!=0)
{
...
if($productdetails->HeatTransferLabelID!=0)
{
...
@if($hangtagsdetails->CMYK=='0')
  ...
  <div class="form-group col-md-6">
   ...
   <div class="form-group col-md-6 ">
    ...
    <div class="form-group col-md-6 ">
      <label class="control-label col-md-4" for="brand">Sample Costing:</label>
      <div class="col-md-8">
        <input type="text" class="form-control" id="pro-grp" name="Product-grp" value="{{$printedlabeldetails->Sample_costing}}"> 
      </div>
    </div>
    <div class="form-group col-md-6 ">
      <label class="control-label col-md-4" for="brand">Language Options:</label>
     ...
     <div class="form-group col-md-6 ">
      <label class="control-label col-md-4" for="brand">CountryOfOrigin:</label>
      <div class="col-md-8">
        <input type="text" class="form-control" id="pro-grp" name="Product-grp" value="{{$printedlabeldetails->CountryofOriginID}}"> 
      </div>
    </div>
    <?php
  $expsizerange=explode("#",$printedlabeldetails->SizeRangeID);
  foreach($expsizerange as $sizerange)
  {
    $valsizerange[]=$sizerange;
  }$implodesizerange=implode(",",$valsizerange);
  ...
  elseif($productdetails->HangTagsID!="")
  {
  ?>
  ...
  ?>
   <?php
  if($productdetails->WovenLabelID!="")
  {
  ?>
  <div class="col-lg-3">
  <div class="img-thumbnail" style="width:150px; height:150px;">
