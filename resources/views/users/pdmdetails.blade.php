        ...
        <div class="table-responsive" style="overflow:hidden">
         ...
         <select id="Hooks_{{$fieldname}}<?php echo $i; ?>" name="Hooks_{{$fieldname}}<?php echo $i; ?>" class="form-control regionselect dropdownwidth">
                ...
                <div class="printcolorhidden">
                 ...
                 @elseif($fieldname=="Mold Costing Currency")
                 <div class="printcolorhidden">
                 <label class="col-lg-2 control-label font-noraml text-left label_font">{{ $list->fieldname }}:@if($list->isvalid==1)<span class="required">*</span>@endif</label>
                   <div class="col-lg-5">
                 ...
                 @elseif($list->fieldname=="Hook Currency")
                 <div class="printcolorhidden">
                 <label class="col-lg-2 control-label font-noraml text-left label_font">{{ $list->fieldname }}:@if($list->isvalid==1)<span class="required">*</span>@endif</label>
                   <div class="col-lg-5">
         ...
         <select id="TissuePaper_{{$fieldname}}<?php echo $k; ?>" name="TissuePaper_{{$fieldname}}<?php echo $k; ?>" class="form-control dropdownwidth regionselect">
             ...
             <div class="printcolorhidden">
                 ...
                 <span class="1cmykyes 1cmykcheckbox"><input type="radio" name="tissueprintcolor" id="tissuecmykyes"  class="tissuechkbox cmyk" value="1"/>Yes</span>&nbsp;
                 </div>
                  <div class="col-lg-5 cmykwidthdiv">
                 <span class="1cmykno 1cmykcheckbox"><input type="radio" name="tissueprintcolor" id="tissuecmykno" class="tissuechkbox cmyk" value="0" checked="checked"  onclick="printcolor();" />No</span>
                </div>
                </div>
...
<!-- Defect:pdf:march14:5
                 ...
                 <div class="printcolorhidden">
                  <label class="col-lg-2 control-label font-noraml text-left label_font">{{ $list->fieldname }}:@if($list->isvalid==1)<span class="required">*</span>@endif</label>
                 <div class="col-lg-5 cmykwidthdiv">
                 <span class="1cmykyes 1cmykcheckbox"><input type="radio" name="packageprintcolor" id="packagecmykyes"  class="packagechkbox cmyk" value="1"  onclick="printcolor();"/>Yes</span>&nbsp;
                 </div>
                  <div class="col-lg-5 cmykwidthdiv">

                 <span class="1cmykno 1cmykcheckbox"><input type="radio" name="packageprintcolor" id="packagecmykno" class="packagechkbox cmyk" value="0" checked="checked"  onclick="printcolor();" />No</span>
                </div>
                </div>
