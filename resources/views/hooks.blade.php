...
/*main content 0f product details*/
...
<td>
	...
	<thead align="center" width="700px" bgcolor="#fff" cellpadding="0" cellspacing="0" border="0" >
		  	<tr width="700px" cellpadding="0" cellspacing="0">	
	 <td width="700px" style="font-family:Arial; font-size:11px;text-align:left; ">To add the cost information please enter to our on line system <a href="<?php echo url('/'); ?>/viewdevelopmentitemlist/<?php echo $productdetails->id; ?>/1/<?php echo $productdetails->HookID;  ?>" style="color:#000; font-weight:bold;"> here.</a></td>
	 	</tr>
				 </thead>
    </table>
    	<table border="0"align="center" width="700px">
    ...
    <tbody align="center" width="700px"  bgcolor="#fff">
        <tr width="700px" style="height:30px;" >
            ...
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">
            {{$rawmaterialdetails->HooksMaterial}}
            </td>
        </tr>
        
        <tr width="700px" style="height: 30px;">
        	<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;"> Quality Reference: </td>
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$hooksdetails->QualityReference}}</td>
        </tr>
        <tr width="700px" style="height: 30px;">
        	<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;"> Quality Color: </td>
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$hooksdetails->Color}}</td>
        </tr>
        
        <tr width="700px" style="height: 30px;">
        	<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;"> Thickness: </td>
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$hooksdetails->Thickness}} @if($hooksdetails->measurement1!=""){{$hooksdetails->measurement1}}
        ...
        <tr width="700px" style="height: 30px;">
            ...
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$hooksdetails->Width}}</td>
        </tr>
        
        
        <tr width="700px" style="height: 30px;">
        	<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;"> Length: </td>
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$hooksdetails->Length}}</td>
        </tr>
        
        <tr width="700px" style="height: 30px;">
        	<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;"> Mold Costing Currency: </td>
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$moldcostingcurrencydetails->Currency}}</td>
        </tr>
        
         <tr width="700px" style="height: 30px;">
        	<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;"> Mold Costing: </td>
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$hooksdetails->MoldCosting}}</td>
        </tr>
