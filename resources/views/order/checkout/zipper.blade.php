                        ...
                        <div class="panel-body panel_orderlist">
                          <?php foreach ($ProductDetails as $Productlist) {
                                  if($Productlist->ZipperCount==1){ ?>
                                                          <div class="row margiontop">
                           <div class="col-xs-4"><h5 class="fontsize">Zipper Pulls Order Details</h5></div>
                                                           </div> 
                        ...
                        <div class="row margiontop">
                                   ...
                                   <a href="javascript:;" class="btn btn-primary fa fa-edit" style="margin-right:10px;"> Edit</a>
                                    <a href="javascript:;" class="btn btn-primary fa fa-trash-o"> Delete</a>
                                                                        </div>
                                   </div>
                                     </div>
...
echo $region->ProductionRegions;
                     ...
                     <div class="step-content">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6"> 
                                    ...
                                    <label class="col-lg-5 control-label font-noraml text-left">Marks PO Number</label>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div class="form-group">
                                    <label class="col-lg-5 control-label font-noraml text-left">PO Date</label>
                                    <div class="col-lg-7 control-label text-left font-bold">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div class="form-group">
                                    <label class="col-lg-5 control-label font-noraml text-left">Style No</label>
                                    <div class="col-lg-7 control-label text-left font-bold"> 
...
echo $table->Season;
                          ...
                          <div class="row margiontop">
                                   <div class="col-xs-12 col-sm-6 col-md-6">
                                    <label class="col-lg-5 control-label font-noraml text-left">Product Code</label>
                                    <div class="col-lg-7 control-label text-left font-bold">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <label class="col-lg-5 control-label font-noraml text-left">Product Description</label>
                                    <div class="col-lg-7 control-label text-left font-bold ">
