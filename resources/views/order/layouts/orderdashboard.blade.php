...
<head>
    ...
    <link href="{{ asset("/custom_css/checkout.css")}}" rel="stylesheet">
...
<body>
  ...
  <!-- Scripts -->
   ...
   <script src="{{ asset('/js/app.js') }}"></script>
    ...
    <script src="{{ asset('/js/custom/chain_custom.js') }}"></script>



    @include('order.includes.commonjs')
