...
/*maincontent for product details*/
...
<td>
	...
	<thead align="center" width="700px" bgcolor="#fff" cellpadding="0" cellspacing="0" border="0" >
		  	<tr width="700px" cellpadding="0" cellspacing="0">	
	 <td width="700px" style="font-family:Arial; font-size:11px;text-align:left; ">To add the cost information please enter to our on line system <a href="<?php echo url('/'); ?>/viewdevelopmentitemlist/<?php echo $productdetails->id; ?>/2/<?php echo $productdetails->TissuePaperID; ?>" style="color:#000; font-weight:bold;"> here.</a>    </td>
	 	</tr>
				 </thead>
    </table>
    	<table border="0"align="center" width="700px">
    ...
    <tbody align="center" width="700px"  bgcolor="#fff">
        ...
        <tr width="700px" style="height: 30px;">
            ...
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$tissuepaperdetails->QualityReference}}</td>
        </tr>
        
        <tr width="700px" style="height: 30px;">
        	<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;"> Thickness: </td>
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$tissuepaperdetails->Thickness}} @if($tissuepaperdetails->measurement1!=""){{$tissuepaperdetails->measurement1}}
        ...
        <tr width="700px" style="height: 30px;">
            ...
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$tissuepaperdetails->Width}}</td>
        </tr>
        
        
        <tr width="700px" style="height: 30px;">
        	<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;"> Length: </td>
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$tissuepaperdetails->Length}}</td>
        </tr>
        ...
        <tr width="700px" style="height: 30px;">
        	<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;"> Color: </td>         @if($tissuepaperdetails->CMYK==0)
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$tissuepaperdetails->PrintColor1}},{{$tissuepaperdetails->PrintColor2}},{{$tissuepaperdetails->PrintColor3}},{{$tissuepaperdetails->PrintColor4}}</td>
             @elseif($tissuepaperdetails->CMYK==1)
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$tissuepaperdetails->PrintColor5}},{{$tissuepaperdetails->PrintColor6}},{{$tissuepaperdetails->PrintColor7}},{{$tissuepaperdetails->PrintColor8}}</td>
            @endif
        ...
        <tr width="700px" style="height: 30px;">
            ...
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{"CuttingName"}}</td>
        </tr>
...
<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">
 <?php
	...
	?>            
        ...
        <tr width="700px" style="height: 30px;">
        	<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">Unique product Code: </td>
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$tissuepaperdetails->UniqueProductCode}}</td>
        </tr>
