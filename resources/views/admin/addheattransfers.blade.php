                    ...
                    <div class="col-lg-12 clsaddnewvendorform">
                        ...
                        <row class="col-md-12">
                            ...
                            <div class="form-group clsformelements">
                               ...
                               <select id="productsubgroup" name="productsubgroup" class="form-control">
                              <option value="">Select Subgroup</option>
                               @foreach($productsubgroupdetails as $productsubgrouplist)
                                <option value="{{$productsubgrouplist->id}}" @if($subgroupdetails->id==$productsubgrouplist->id)selected="selected" @endif>{{$productsubgrouplist->ProductSubGroupName}}</option>
                                @endforeach
                              </select>
                        ...
                        <row class="col-md-12">
                            ...
                            <div class="form-group clsformelements">
                                ...
                                <div class="col-md-3">
                                 ...
                                 <textarea id="decription" name="description" class="form-control" rows="2" cols="200"></textarea>
                                </div>
  							</div>
