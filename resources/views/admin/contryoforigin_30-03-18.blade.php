...
<div class="col-lg-12">
    ...
    //Add zipper color insert code*/ -->
                       <div class="title-action">
                        <a href="" class="btn btn-primary fa fa-plus addnewlabelprint" data-toggle="modal" data-target="#myModal"> addnewcountryoforigin</a>
                    </div> 
                   ...
                   <!--   <h5>View all |&nbsp;Export Results-Excel File| &nbsp;<a href="javascript:window.print();">Print Current Page</a></h5>-->
                    ...
                    <tr>
                       ...
                       <!-- <th><input name="select_all" value="1" type="checkbox"></th>-->
                        ...
                        <th>Description Polish</th>
                        <th>Description Chinese</th>
                        <th>Description Romanian</th>
                        <th>Description Turkish</th>
                        <th>Description Czech</th>
                        <th>Description Hungarian</th>
                        <th>Description Slovak</th>
                        <th>Description Portuguese</th>
                        <th>Description Flemish</th>
                        <th>Description Italian</th>
                        <th>Description German</th>
                        <th>Description Danish</th>
                        <th>Description Bulgarian</th>
...
$customer=\App\Customers::where('id', $coolist->customerID)->first();
                    ...
                    <td>
                        ...
                        <a class="editcoodetails" data-href="{{ url('/') }}" data-selecthref="{{ route('product.editcoodetails', ['id' => $coolist->id]) }}" data-toggle="modal" data-valueid="{{ $coolist->id }}" data-target="#myModal"><img src="{{ asset('/img/edit.png') }}" border="0"  title="Edit"/></a> 

                       

                        

                        <a class="deletecoo" data-href="{{ url(route('product.coodelete', ['id' => $coolist->id])) }}"><span  data-valueid="{{ $coolist->id }}"><img  src="{{ asset('/img/delete.png') }}" border="0"  title="Delete"/></a>

                          @if ($coolist->status==0)
                        
                        <span class="activatecoo"><a data-href="{{ url(route('product.cooactivenew',['id' => $coolist->id])) }}"><img  src="{{ asset('/img/active.png') }}" border="0"  title="Activate"/></a></span> 
                        @else
                         <span class="deactivatecoo"><a data-href="{{ url(route('product.coodeactivenew',['id' => $coolist->id])) }}"><img  src="{{ asset('/img/deactive.png') }}" border="0"  title="Deactivate"/></a></span> 
                         @endif
                            ...
                            <div class="modal inmodal" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
                                ...
                                <div class="modal-content animated bounceInRight">
                                 <div class="chain_bg">
                                        ...
                                        <form name="countryadd" id="countryadd" method="post" action="{{url(route('product.addnewcoo'))}}" class="form-horizontal">
                                          {{ csrf_field() }}
