...
<body>
  ...
  <div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg vendor">
  ...
  <!-- Scripts -->
   ...
   <script src="{{ asset('/js/app.js') }}"></script>
    ...
    <script src="{{ asset('/js/custom/customerusers_custom.js') }}"></script>
    
     <script src="{{ asset('/js/custom/vendorusers_custom.js') }}"></script>
    
    <script src="{{ asset('/js/custom/states_custom.js') }}"></script>
    
     <script src="{{ asset('/js/custom/uniquefacility_custom.js') }}"></script>
