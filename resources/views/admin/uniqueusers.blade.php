            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                   ...
                   <!-- <td><?php /*?><?php echo '<input type="checkbox" name="ChkEvent[]" id="ChkEvent[]" value="'.$users_list->id.'" class="hobbies_class">'; ?><?php */?></td>-->
                        ...
                        <span class="activatuniqueuser"><a data-href="{{ url(route('uniqueuser.activate',['id' => $users_list->id])) }}"><img  src="{{ asset('/img/active.png') }}" border="0"  title="Activate"/></a></span> 
                        @else
                         <span class="deactivateuniqueuser"><a data-href="{{ url(route('uniqueuser.deactivate',['id' => $users_list->id])) }}"><img  src="{{ asset('/img/deactive.png') }}" border="0"  title="DeActivate"/></a></span> 
                         @endif
