...
<?php $customeruserid=$_GET['id'];   ?>
        ...
        <div id="form-group">
          <div class="col-lg-12">
            <button class="button" style=" z-index:1; position:relative;" onclick="location.href='{{ url(route('customeruser.edit', ['id' => $customeruserid])) }}'">Edit Customer User</button>
		  </div>
...
<div class="col-lg-12 clsaddnewvendorform">
                    ...
                    <td style="background-color:#CCCCCC;">{{ $customers_list->FirstName }}</td>
                    </tr>
                    <tr>
                    ...
                    <td style="background-color:#CCCCCC;">{{ $customers_list->UserName }}</td>
                    </tr>
                    <tr>
                    ...
                    <td style="background-color:#CCCCCC;">Address</td>
                     ...
                     <td style="background-color:#CCCCCC;">{{ $customers_list->Suite }} {{ $customers_list->Street }}, {{ $customers_list->City }}, {{ $customers_list->ZIPcode }}</td>
                    </tr>
