...
<span id="phoneerror" style="display: none;" class="mandatory_fields">Not valid phone number</span>
                   ...
                   <row class="col-md-12">
                            ...
                            <div class="form-group clsformelements">
                                ...
                                @if($type_list->id==12)
                                <option value="{{$type_list->id}}" "@if($type_list->id==12) {{12 == 12 ? 'selected' : ''}} @endif">{{$type_list->userType}}</option>
                                @endif
                                @endforeach
                  ...
                  <label for="Warehouse_Name" class="col-md-3">Customer Warehouse Name<span class="mandatory_fields">*</span></label>
                          ...
                          <input type="text" name="Warehouse_Name" id="Warehouse_Name" placeholder="Warehouse Name" class="form-control" value="@if($edit_val==1){{$customersUsers->Warehouse_Name}}@endif"/>
                  ...
                  <label for="Warehouse_Suite" class="col-md-3">Warehouse Suite/Unit<span class="mandatory_fields">*</span></label>
                        ...
                        <input type="text" name="Warehouse_Suite" id="Warehouse_Suite" placeholder="Suite/Unit" class="form-control" value="@if($edit_val==1){{$customersUsers->Warehouse_Suite}}@endif"/>
                  ...
                  <label for="Warehouse_street" class="col-md-3">Warehouse Street<span class="mandatory_fields">*</span></label>
                        ...
                        <input type="text" name="Warehouse_street" id="street" placeholder="Street" class="form-control" value="@if($edit_val==1){{$customersUsers->Warehouse_street}}@endif"/>
                  ...
                  <label for="Warehouse_city" class="col-md-3">Warehouse City<span class="mandatory_fields">*</span></label>
                          ...
                          <input type="text" name="Warehouse_city" id="city" placeholder="City" class="form-control" value="@if($edit_val==1){{$customersUsers->Warehouse_city}}@endif"/>
              ...
              <select id="Warehouse_CountryID" name="Warehouse_CountryID" class="form-control" >

                        <option value=""> Please Select Country</option>

                        @foreach($countries_details as $countrieslist)

                        <option value="{{$countrieslist->CountryID}}" "@if($edit_val==1) {{$customersUsers->Warehouse_CountryID==$countrieslist->CountryID ? 'selected' : ''}} @endif" drop-data="{{url(route('admin.selectstate', ['id' => $countrieslist->CountryID]))}}">{{$countrieslist->Country}}</option>
              ...
              <select id="Warehouse_StateID" name="Warehouse_StateID" class="form-control">
                        ...
                        <option value="{{$statelist->id}}" "@if($edit_val==1) {{$customersUsers->Warehouse_StateID == $statelist->id ? 'selected' : ''}} @endif">{{$statelist->StateName}}</option>
                  ...
                  <label for="Warehouse_Zipcode" class="col-md-3">Warehouse Zip Code<span class="mandatory_fields">*</span></label>
                                ...
                                <input type="text" name="Warehouse_Zipcode" id="zipcode" placeholder="Zip Code" class="form-control" value="@if($edit_val==1){{$customersUsers->Warehouse_Zipcode}}@endif" />
