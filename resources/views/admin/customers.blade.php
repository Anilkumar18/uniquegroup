...
<div class="col-lg-12 clsbreadcrumb">
       ...
       <p> > Customer Maintenance - Customer</p>

</div>

<button class="button addnewcustomerusers" onclick="location.href='{{ url(route('admin.addnewcustomers'))}}'">Add New Customer</button>
