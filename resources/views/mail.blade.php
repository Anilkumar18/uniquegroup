...
$requestdate=date('F j,Y',strtotime($productdetails->created_at));
 ...
 if($boxid!="")
 {
	$boxesdetails=App\Boxes::where('ProductID','=',$Productid)->where('status','=',1)->first();
 ...
 elseif($hangtagsid!="")
 {
   $hangtagsdetails=App\HangTags::where('ProductID','=',$Productid)->where('status','=',1)->first();	
   ...
   $rawmaterialdetails=App\RawMaterial::where('id','=',$hangtagsdetails->MaterialID)->where('status','=',1)->first(); 
	...
	elseif($tapesid!="")
 {
   $tapesdetails=App\Tapes::where('ProductID','=',$Productid)->where('status','=',1)->first();	
...
<td>
	...
	<thead align="center" width="700px" bgcolor="#fff" cellpadding="0" cellspacing="0" border="0" >
		  	<tr width="700px" cellpadding="0" cellspacing="0">	
	 <td width="700px" style="font-family:Arial; font-size:11px;text-align:left; ">To add the cost information please enter to our on line system <a href="<?php echo url('/'); ?>/viewdevelopment/<?php echo $productdetails->id; ?>" style="color:#000; font-weight:bold;"> here.</a>    </td>
	 	</tr>
				 </thead>
    </table>
    	<table border="0"align="center" width="700px">
	...
	if($boxid!="")
 {
    ...
    <tbody align="center" width="700px"  bgcolor="#fff">
        ...
        <tr width="700px" style="height: 30px;">
            ...
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$boxesdetails->QualityReference}}</td>
        </tr>
        
        <tr width="700px" style="height: 30px;">
        	<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;"> Thickness: </td>
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$boxesdetails->Thickness}} @if($boxesdetails->measurement1!=""){{$boxesdetails->measurement1}}
        ...
        <tr width="700px" style="height: 30px;">
            ...
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$boxesdetails->Width}}</td>
        </tr>
        
        <tr width="700px" style="height: 30px;">
        	<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">Height: </td>
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$boxesdetails->Height}}</td>
        </tr>
        
        <tr width="700px" style="height: 30px;">
        	<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;"> Length: </td>
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$boxesdetails->Length}}</td>
        </tr>
        ...
        <tr width="700px" style="height: 30px;">
        	<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;"> Color: </td>         @if($boxesdetails->CMYK==0)
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$boxesdetails->PrintColor1}},{{$boxesdetails->PrintColor2}},{{$boxesdetails->PrintColor3}},{{$boxesdetails->PrintColor4}}</td>
             @elseif($boxesdetails->CMYK==1)
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$boxesdetails->PrintColor5}},{{$boxesdetails->PrintColor6}},{{$boxesdetails->PrintColor7}},{{$boxesdetails->PrintColor8}}</td>
            @endif
...
<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">
 ...
 elseif($hangtagsid!="")
 {
    ...
    <tbody align="center" width="700px"  bgcolor="#fff">
        ...
        <tr width="700px" style="height: 30px;">
        	<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;"> Quality Reference: </td>
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$hangtagsdetails->QualityReference}}</td>
        </tr>
        
        <tr width="700px" style="height: 30px;">
        	<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;"> Thickness: </td>
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$hangtagsdetails->Thickness}} @if($hangtagsdetails->measurement1!=""){{$hangtagsdetails->measurement1}}
        ...
        <tr width="700px" style="height: 30px;">
        	<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">Width: </td>
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$hangtagsdetails->Width}}</td>
        </tr>
        
        <tr width="700px" style="height: 30px;">
        	<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">Height: </td>
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$hangtagsdetails->Height}}</td>
        </tr>
        
        <tr width="700px" style="height: 30px;">
        	<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;"> Length: </td>
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$hangtagsdetails->Length}}</td>
        </tr>
        
        <tr width="700px" style="height: 30px;">
        	<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;"> Print Type: </td>
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$hangtagsdetails->PrintType}} </td>
        </tr>
        
        <tr width="700px" style="height: 30px;">
        	<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;"> Color: </td>         @if($hangtagsdetails->CMYK==0)
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$hangtagsdetails->PrintColor1}},{{$hangtagsdetails->PrintColor2}},{{$hangtagsdetails->PrintColor3}},{{$hangtagsdetails->PrintColor4}}</td>
             @elseif($hangtagsdetails->CMYK==1)
            <td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">{{$hangtagsdetails->PrintColor5}},{{$hangtagsdetails->PrintColor6}},{{$hangtagsdetails->PrintColor7}},{{$hangtagsdetails->PrintColor8}}</td>
            @endif
...
<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">
 ...
 elseif($tapesid!="")
 {
    ...
    <tbody align="center" width="700px"  bgcolor="#fff">
        ...
        <tr width="700px" style="height: 30px;">
        	<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">Tape Color: </td>
        ...
        <tr width="700px" style="height: 30px;">
        	<td width="350px" style="font-family:Arial; font-size:11px;text-align:left; border-bottom:1px solid #000;">Tape Width: </td>
