...
<tbody><tr>
    <td align="center" valign="top">
       ...
       <tr><td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tbody><tr><td style="margin:0px auto;float:left;padding-top:4px;padding-left:2%;font-size:13px;font-family:Verdana;line-height:20px;">Hello <span style="font-size:13px;">Bala Murugan,</span></td><td align="right" style="font-family:Verdana;font-size:12px;color:#585858; padding-top: 8px;">&nbsp; </td></tr></tbody></table></td></tr>     


<tr>
	<table align="left" border="1" cellpadding="0" cellspacing="0" width="100%" style="font-family:Arial; font-size:12px;">
  		        <tbody><tr>
		       <th style="text-align: left;padding: 8px;background-color: #51ade1 ;color: white;">Customer Product Code</th>
		<th style="text-align: left;padding: 8px;background-color: #51ade1 ;color: white;">PO Number</th>
		...
		<td style="text-align: left;padding: 5px;">PO01</td>
		 <td style="text-align: left;padding: 5px;">product code01</td>
              	<td style="text-align: left;">
				<table align="left" border="0" cellpadding="0" cellspacing="0" width="60%" style="font-family:Arial; font-size:12px;margin:9%;">
		<tbody><tr><td style="background-color: #1ab394;border-color: #1ab394;color: #FFFFFF; border-radius: 3px;float: left; width: 75px;text-align: center;"><a href="laravel/uniquegroup/public/admin/customers" target="_blank" style="color: #FFFFFF;border-radius: 3px;">Approve</a></td></tr></tbody></table><br/><br/><table align="left" border="0" cellpadding="0" cellspacing="0" width="60%" style="font-family:Arial; font-size:12px; margin:10%;">
		<tbody><tr><td style="background-color: #ed5565;border-color: #ed5565;color: #FFFFFF; border-radius: 3px;float: left; width: 75px;text-align: center;"><a href="laravel/uniquegroup/public/admin/customerusers" target="_blank" style="color: #FFFFFF;border-radius: 3px;">Reject</a></td></tr></tbody></table>
