...
<tbody><tr>
    <td align="center" valign="top">
       ...
       <tr><td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tbody><tr><td style="margin:0px auto;float:left;padding-top:4px;padding-left:2%;font-size:13px;font-family:Verdana;line-height:20px;">Hello<span style="font-size:13px;">Administrator,</span></td><td align="right" style="font-family:Verdana;font-size:12px;color:#585858; padding-top: 8px;">I reviewed the Suggested price </td></tr></tbody></table></td></tr>     
...
<tr>
	<table align="left" border="1" cellpadding="0" cellspacing="0" width="100%" style="font-family:Arial; font-size:12px;">
		...
		<tbody><tr><td style="background-color: #1ab394;border-color: #1ab394;color: #FFFFFF; border-radius: 3px;float: left; width: 75px;text-align: center;"><a href="{{ url(route('adminapprovalform',['id'=>$productdetails->id]))}}" target="_blank" style="color: #FFFFFF;border-radius: 3px;">Approve</a></td></tr></tbody></table><br/><br/><table align="left" border="0" cellpadding="0" cellspacing="0" width="60%" style="font-family:Arial; font-size:12px; margin:10%;">
		<tbody><tr><td style="background-color: #ed5565;border-color: #ed5565;color: #FFFFFF; border-radius: 3px;float: left; width: 75px;text-align: center;"><a href="{{ url(route('customerserviceactivate',['id'=>$productdetails->id]))}}" target="_blank" style="color: #FFFFFF;border-radius: 3px;">Reject</a></td></tr></tbody></table>
