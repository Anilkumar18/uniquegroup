...
<!--<div class="col-lg-12 clsbreadcrumb">
       ...
       <p> > Product Maintenance - Care Instructions Iron Maintenance</p>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-title">
                          ...
                          <div class="col-lg-8">
                    <h2>Care Instructions-IRON</h2>
                    
                    
                  
                </div>
                
                <a href="" class=" button fa fa-plus addnewcustomerusers addnewsymbol" data-toggle="modal" data-target="#myModal5"> Add New Symbol</a>  <ol class="breadcrumb">
                        <li>
                            <a href="">Home</a>
                        </li>
                        ...
                        <li class="active">
                            <strong>Care Instructions-IRON</strong>
                        </li>
                 ...
                 <img src='../img/image-sample.jpg' width="60" height="60"  />@endif</td>
                   ...
                   <!-- <td>{{$symbollists->descriptionSpanish}}</td>
                    ...
                    <td>
                      <a data-href="{{ url('/') }}" data-selecthref="{{ url(route('admin.ironsymbolselect', ['id' => $symbollists->id])) }}"  href="javascript:;" class="ViewSymbol" data-valueid="{{ $symbollists->id }}" data-toggle="modal" data-target="#myModal6"><img  src="{{ asset('/img/view.png') }}" border="0"  title="Edit"/></a>

                <a data-href="{{ url('/') }}" data-selecthref="{{ url(route('admin.ironsymbolselect', ['id' => $symbollists->id])) }}"  href="javascript:;" class="editSymbol" data-valueid="{{ $symbollists->id }}" data-toggle="modal" data-target="#myModal5"><img  src="{{ asset('/img/edit.png') }}" border="0"  title="Edit"/></a>


                       <span class="deletesymbol" data-href="{{ url(route('admin.ironsymboldelete',['id' => $symbollists->id])) }}"  data-valueid="{{ $symbollists->id }}"><a href="javascript:;"><img  src="{{ asset('/img/delete.png') }}" border="0"  title="Delete"/></a></span>
                       
                        @if ($symbollists->status==0)
                        
                        <span class="activatsymbol"><a data-href="{{ url(route('admin.ironsymbolactive',['id' => $symbollists->id])) }}"><img  src="{{ asset('/img/active.png') }}" border="0"  title="Activate"/></a></span> 
                        @else
                         <span class="deactivatesymbol"><a data-href="{{ url(route('admin.ironsymboldeactive',['id' => $symbollists->id])) }}"><img  src="{{ asset('/img/deactive.png') }}" border="0"  title="Deactivate"/></a></span> 
                         @endif
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content animated bounceInRight">
      <div class="chain_bg">
        ...
        <form name="symbolmaintenanceadd" id="symbolmaintenanceadd" method="post"  action="{{ url(route('admin.ironadd_symbolist')) }}" class="form-horizontal" enctype="multipart/form-data">
          {{ csrf_field() }}
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <div class="col-lg-7">
                    ...
                    <?php
					$symboltypedetails=App\SymbolType::where('id','=',3)->where('status','=',1)->get();
					?> 
