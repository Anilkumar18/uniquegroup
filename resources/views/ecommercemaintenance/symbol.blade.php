@extends('ecommercemaintenance.layouts.symbol')
<?php
error_reporting(0);
?>
...
<!--<div class="col-lg-12 clsbreadcrumb">
       ...
       <p> > Product Maintenance -Symbol Maintenance</p>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Symbol Maintenance</strong>
                        </li>
                 ...
                 <a href="" class=" button fa fa-plus addnewcustomerusers addnewsymbol" data-toggle="modal" data-target="#myModal5"> Add New Symbol</a>
                   ...
                   <!--   <h5>View all |&nbsp;Export Results-Excel File| &nbsp;<a href="javascript:window.print();">Print Current Page</a></h5>-->
                    ...
                    @foreach($symbollist as $symbollists)    
                        ...
                        <tr>
                       <!--  <td><?php /*?><?php echo '<input type="checkbox" name="ChkEvent[]" id="ChkEvent[]" value="'.$symbollists->id.'" class="hobbies_class">'; ?><?php */?></td>-->
                 ...
                 <img src='../img/image-sample.jpg' width="60" height="60"  />@endif</td>
                    ...
                    <td>{{$symbollists->descFrench}}</td>
                    <td>
                    <a data-href="{{ url('/') }}" data-selecthref="{{ url(route('admin.symbolselect', ['id' => $symbollists->id])) }}"  href="javascript:;" class="ViewSymbol" data-valueid="{{ $symbollists->id }}" data-toggle="modal" data-target="#myModal6"><img  src="{{ asset('/img/view.png') }}" border="0"  title="Edit"/></a>

                <a data-href="{{ url('/') }}" data-selecthref="{{ url(route('admin.symbolselect', ['id' => $symbollists->id])) }}"  href="javascript:;" class="editSymbol" data-valueid="{{ $symbollists->id }}" data-toggle="modal" data-target="#myModal5"><img  src="{{ asset('/img/edit.png') }}" border="0"  title="Edit"/></a>


                       <span class="deletesymbol" data-href="{{ url(route('admin.symboldelete')) }}"  data-valueid="{{ $symbollists->id }}"><a href="javascript:;"><img  src="{{ asset('/img/delete.png') }}" border="0"  title="Delete"/></a></span>

                         @if ($symbollists->status==0)
                        <span class="activatsymbol"><a data-href="{{ url(route('admin.symbolactive',['id' => $symbollists->id])) }}"><img  src="{{ asset('/img/active.png') }}" border="0"  title="Activate"/></a></span> 
                        @else
                         <span class="deactivatesymbol"><a data-href="{{ url(route('admin.symboldeactive',['id' => $symbollists->id])) }}"><img  src="{{ asset('/img/deactive.png') }}" border="0"  title="Deactivate"/></a></span> 
                         @endif
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content animated bounceInRight">
      <div class="chain_bg">
        ...
        <form name="symbolmaintenanceadd" id="symbolmaintenanceadd" method="post"  action="{{ url(route('admin.add_symbolist')) }}" class="form-horizontal" enctype="multipart/form-data">
          {{ csrf_field() }}
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <div class="col-lg-7">
                    ...
                    <?php
					$symboltypedetails=App\SymbolType::where('status','=',1)->get();
					?> 
             ...
             @if($imagelist->imageName!="")
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <div class="col-lg-4"> <img src="{{ route('admin.symbolimage',['id' =>$imagelist->id]) }}" width="60" height="60" /> </div>
