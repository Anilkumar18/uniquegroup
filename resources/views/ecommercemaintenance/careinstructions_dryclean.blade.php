            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-title">
                        ...
                        <div class="col-lg-8">
                    <h2>Care Instructions-DRYCLEAN</h2>
                  ...
                  <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Care Instructions-DRYCLEAN</strong>
                        </li>
                 ...
                 <img src='../img/image-sample.jpg' width="60" height="60"  />@endif</td>
                   ...
                   <!-- <td>{{$symbollists->descriptionSpanish}}</td>
                    ...
                    <td>
                     <a data-href="{{ url('/') }}" data-selecthref="{{ url(route('admin.drycleansymbolselect', ['id' => $symbollists->id])) }}"  href="javascript:;" class="ViewSymbol" data-valueid="{{ $symbollists->id }}" data-toggle="modal" data-target="#myModal6"><img  src="{{ asset('/img/view.png') }}" border="0"  title="Edit"/></a>
