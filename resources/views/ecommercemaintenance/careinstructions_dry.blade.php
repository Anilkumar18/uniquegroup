...
<!--<div class="col-lg-12 clsbreadcrumb">
       ...
       <p> > Product Maintenance - Care Instructions Dry Maintenance</p>
 ...
 <div class="col-lg-12 clsaddnewvendorform">
            ...
            <div class="row">
                ...
                <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Care Instructions-DRY</strong>
                        </li>
                 ...
                 <img src='../img/image-sample.jpg' width="60" height="60"  />@endif</td>
                   ...
                   <td>{{$symbollists->descFrench}}</td>
                    ...
                    <td>
                     ...
                     <a data-href="{{ url('/') }}" data-selecthref="{{ url(route('admin.drysymbolselect', ['id' => $symbollists->id])) }}"  href="javascript:;" class="ViewSymbol" data-valueid="{{ $symbollists->id }}" data-toggle="modal" data-target="#myModal6"><img  src="{{ asset('/img/view.png') }}" border="0"  title="Edit"/></a>

                <a data-href="{{ url('/') }}" data-selecthref="{{ url(route('admin.drysymbolselect', ['id' => $symbollists->id])) }}"  href="javascript:;" class="editSymbol" data-valueid="{{ $symbollists->id }}" data-toggle="modal" data-target="#myModal5"><img  src="{{ asset('/img/edit.png') }}" border="0"  title="Edit"/></a>


                       <span class="deletesymbol" data-href="{{ url(route('admin.drysymboldelete',['id' => $symbollists->id])) }}"  data-valueid="{{ $symbollists->id }}"><a href="javascript:;"><img  src="{{ asset('/img/delete.png') }}" border="0"  title="Delete"/></a></span>
                       
                        @if ($symbollists->status==0)
                        
                        <span class="activatsymbol"><a data-href="{{ url(route('admin.drysymbolactive',['id' => $symbollists->id])) }}"><img  src="{{ asset('/img/active.png') }}" border="0"  title="Activate"/></a></span> 
                        @else
                         <span class="deactivatesymbol"><a data-href="{{ url(route('admin.drysymboldeactive',['id' => $symbollists->id])) }}"><img  src="{{ asset('/img/deactive.png') }}" border="0"  title="Deactivate"/></a></span> 
                         @endif
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <div class="col-lg-7">
                    ...
                    <?php
					$symboltypedetails=App\SymbolType::where('id','=',5)->where('status','=',1)->get();
					?> 
