...
<tr>
	<table align="left" border="1" cellpadding="0" cellspacing="0" width="100%" style="font-family:Arial; font-size:12px;">
  		        <tbody><tr>
		       <th style="text-align: left;padding: 8px;background-color: #51ade1 ;color: white;">PackageStickersid</th>
		<th style="text-align: left;padding: 8px;background-color: #51ade1 ;color: white;">Productid</th>
    	<th style="text-align: left;padding: 8px;background-color: #51ade1 ;color: white;">Brand</th>
        <th style="text-align: left;padding: 8px;background-color: #51ade1 ;color: white;">ProgramName</th>
		<th style="text-align: left;padding: 8px;background-color: #51ade1 ;color: white;">Status</th>
				</tr> 
		       <tr>
				<td style="text-align: left;padding: 5px;">{{$packagedetails->id}}</td>
		<td style="text-align: left;padding: 5px;">{{$packagedetails->ProductID}}</td>
		 <td style="text-align: left;padding: 5px;">{{$productdetails->Brand}}</td>
          <td style="text-align: left;padding: 5px;">{{$productdetails->ProgramName}}</td>
              	<td style="text-align: left;">@if($packagedetails->status==1){{'Active'}}@endif</td></tr></tbody></table>
</tr>
