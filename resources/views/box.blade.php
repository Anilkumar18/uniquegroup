...
/*main content of product details*/
...
<td>
	...
	<thead align="center" width="700px" bgcolor="#fff" cellpadding="0" cellspacing="0" border="0" >
		  	<tr width="700px" cellpadding="0" cellspacing="0">	
	 <td width="700px" style="font-family:Arial; font-size:11px;text-align:left; ">To add the cost information please enter to our on line system <a href="<?php echo url('/'); ?>/viewdevelopmentitemlist/<?php echo $productdetails->id; ?>/0/0" style="color:#000; font-weight:bold;"> here.</a>    </td>
	 	</tr>
				 </thead>
    </table>
    	<table border="0"align="center" width="700px">
